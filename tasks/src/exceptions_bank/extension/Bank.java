...
public class Bank {
    ...
    public static void main(String[] args) {
        ...
        boolean systemErrorOccured = false;
        while (!systemErrorOccured) {
            try {
                accounts[0].transfer(1000, accounts[5]);
            } catch (InsufficientFundsException | SystemException ex) {
